...
public class RectangularBuildingFloor extends ParametricShape
{
	...
	{
		paths.push_back(prefix+"/RectangularBuildingFloor");
	}

	public RectangularBuildingFloor()
	{
		parameters = new double[]{5.5,4.5,2.4};
	}

	public ParametricShape copy()
	{
		RectangularBuildingFloor c = new RectangularBuildingFloor();
