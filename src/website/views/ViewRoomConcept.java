...
public class ViewRoomConcept extends DynamicWebPage
{
	public ViewRoomConcept(FileStoreInterface fs)
	{
		super(fs);
	}
	public boolean process(WebRequest toProcess)
	{
        if(toProcess.path.startsWith("ViewRoomConcept.html"))
        {
        	return true;
        }
        return false;
	...
	public void out(WebRequest r,Object metadata,OutputStream s)
	{
		...
		for(int i=0;i<insts.length;i++)
		{
			...
			pw.append("<a href=\"/EditRoomInstance.html/"+concept+"/"+inst+"\">"+inst+"</a><br>");
		}
		pw.flush();
	}
}