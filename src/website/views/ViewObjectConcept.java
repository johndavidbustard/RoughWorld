...
public class ViewObjectConcept extends DynamicWebPage
{
	public ViewObjectConcept(FileStoreInterface fs)
	{
		super(fs);
	}
	...
	{
        if(toProcess.path.startsWith("ViewObjectConcept.html"))
        {
        	return true;
        }
        return false;
